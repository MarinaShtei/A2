...
const Login = () => {
    ...
    const login = async () => {
        try {
            ...
            if (user) {
                ...
                window.location.href = 'event.html'; // Change 'event.html' to your intended route
            } else {
    ...
    return (
        <div className="flex justify-center items-center h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 space-y-3 rounded-lg bg-white shadow-md">
                ...
                <input
                    ...
                    className="block w-full px-4 py-2 mt-2 border rounded-md bg-gray-50 focus:border-blue-500 focus:ring-blue-500 focus:outline-none focus:ring focus:ring-opacity-40"
                    value={username}
                ...
                <button
                    onClick={login}
                    className="w-full px-4 py-2 text-white bg-blue-500 rounded-md focus:bg-blue-600 focus:outline-none"
                >
                    Login
                </button>
                <div className="text-center">
                    <a href="/password_recovery" className="text-sm text-blue-500 hover:underline">Forgot your password?</a>
